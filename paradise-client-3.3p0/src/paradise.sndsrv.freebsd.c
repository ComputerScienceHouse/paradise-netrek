/*
 * paradise.sndsrv.c - VoxWare(tm) Compatible Sound - Jan. 1995
 *                     PC Speaker  Compatible Sound 
 *                     This server is FreeBSD Specific.
 *
 * Copyright 1995 Sujal M. Patel (smpatel@wam.umd.edu)
 * Conditions in "copyright.h"
 *
 * Notes: Wow!  Doesn't this code like really close to the Linux code :)
 */
